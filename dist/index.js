...
const cantidadBarras = document.getElementById('barraCantidad');
const colores = ['#00BFFF', '#9ACD32', '#FF1493', '#FFA500']; // Puedes mantener o quitar
let valores = [];
(_a = document.getElementById('btn_generar')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
...
*/
function pintarBarras(porcentajes) {
    ctx.clearRect(0, 0, canvas.width, canvas.height);
    const anchoBarra = 40;
    const espacio = 20;
    const altoMax = 400;
